$(function() {
  var update_date = function() {
    ...
    var start = new Date(Date.UTC(2010, 6, 31, 1, 0, 0)).valueOf();
    // "Sat Aug 01 01:00:00 UTC 2010"
    var finish = new Date(Date.UTC(2010, 7, 1, 1, 0, 0)).valueOf();
    // "Sat Jul 31 01:00:00 UTC 2011"
    var next = new Date(Date.UTC(2011, 6, 31, 1, 0, 0)).valueOf();

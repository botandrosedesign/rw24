      ...
      error: function(xhr, textStatus, errorThrown) {
        $("#"+id).removeClass("pending").addClass("failed")
          .find("td:last-child").html('\
            <a href="/points/new?id=' + id + '&' + queryString + '" class="ceebox" title="New Score" rel="modal: true width:500 height:200">Create From</a>\
            <a href="#" onclick="$(this).parent().parent().remove(); return false;">Clear</a>\
          ')

      ...
      error: function(xhr, textStatus, errorThrown) {
        $("#"+id).removeClass("pending").addClass("failed")
          .find("td:last-child").html('\
            <a href="/points/new?id=' + id + '&' + queryString + '" class="ceebox edit" title="New Score" rel="modal: true width:500 height:325">Edit</a>\
            <a href="#" onclick="$(this).parent().parent().remove(); return false;" class="delete">Delete</a>\
          ')
